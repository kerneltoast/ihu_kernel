...
#define CFG2_SNR_WLIMIT_SHIFT     (6)
#define CFG2_SNR_WLIMIT_MAX       (7)
...
#define INTERRUPT_ERROR_EVENT  (INTERRUPT_PHY_INIT_FAIL    | \
                                INTERRUPT_LINK_STATUS_FAIL | \
                                INTERRUPT_SYM_ERR          | \
                                INTERRUPT_CONTROL_ERROR    | \
                                INTERRUPT_UV_ERR           | \
                                INTERRUPT_TEMP_ERROR)

/* interrupt_enable register */
#define INTERRUPT_PWON_EN                    BIT(15)
#define INTERRUPT_WAKEUP_EN                  BIT(14)
#define INTERRUPT_WUR_RECEIVED_EN            BIT(13)
#define INTERRUPT_LPS_RECEIVED_EN            BIT(12)
#define INTERRUPT_PHY_INIT_FAIL_EN           BIT(11)
#define INTERRUPT_LINK_STATUS_FAIL_EN        BIT(10)
#define INTERRUPT_LINK_STATUS_UP_EN          BIT(9)
#define INTERRUPT_SYM_ERR_EN                 BIT(8)
#define INTERRUPT_TRAINING_FAILED_EN         BIT(7)
#define INTERRUPT_SNR_WARNING_EN             BIT(6)
#define INTERRUPT_CONTROL_ERROR_EN           BIT(5)
#define INTERRUPT_TXEN_CLAMPED_EN            BIT(4)
#define INTERRUPT_UV_ERR_EN                  BIT(3)
#define INTERRUPT_UV_RECOVERY_EN             BIT(2)
#define INTERRUPT_TEMP_ERROR_EN              BIT(1)
#define INTERRUPT_SLEEP_ABORT_EN             BIT(0)
...
#define LINK_FAIL_LOC_RCVR_CNT_MSK   (0x0000FF00U)
#define LINK_FAIL_REM_RCVR_CNT_MSK   (0x000000FFU)

#define LINK_FAIL_LOC_RCVR_CNT_SHIFT (8)
#define LINK_FAIL_REM_RCVR_CNT_SHIFT (0)

/* External status register */
#define EXTSTAT_OPEN_DETECT       BIT(7)
#define EXTSTAT_SHORT_DETECT      BIT(8)
#define EXTSTAT_TEMP_WARN         BIT(9)
#define EXTSTAT_TEMP_HIGH         BIT(10)
#define EXTSTAT_UV_VDDIO          BIT(11)
#define EXTSTAT_UV_VDDA_1V8       BIT(12)
#define EXTSTAT_UV_VDDD_1V8       BIT(13)
#define EXTSTAT_UV_VDDA_3V3       BIT(14)
...
struct phy_counters_tag
{
   uint32_t link_status_up;
   uint32_t link_status_fail;
   uint32_t loc_rcvr_fail;
   uint32_t rem_rcvr_fail;
   uint32_t trans_rx_err;
   uint32_t trans_tx_err;
   uint32_t sqi_warn;
   uint32_t mii_err;
   uint32_t phy_init_fail;
   uint32_t symbol_err;
   uint32_t ssd_err;
   uint32_t esd_err;
   uint32_t temp_err;
   ...
   uint32_t temp_warn;
   uint32_t uv_err;
   uint32_t uv_vdda_3v3;
   uint32_t uv_vddd_1v8;
   uint32_t uv_vdda_1v8;
   uint32_t uv_vddio;
};
...
struct nxp_specific_data {
	int is_master;
	int poll_setup;
	struct phy_counters_tag phy_counters;
